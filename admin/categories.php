            ...
            <form method="POST" action="categories.php">
                ...
                <?php if ($editCategory): ?>
                    <div class="mt-2 text-center">
                        <a href="categories.php" class="text-sm text-gray-500 hover:text-gray-800">Batal Edit</a>
                    </div>
                <?php endif; ?>
            </form>
        </div>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                <a href="categories.php?edit=<?= $cat['id'] ?>" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                    </svg>
                                </a>
                                <a href="categories.php?delete=<?= $cat['id'] ?>" onclick="return confirm('Yakin ingin menghapus kategori ini?')" class="w-4 transform hover:text-red-500 hover:scale-110">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
